...
let arrayAnswer = bigOrSmall(bigOrSmallArray)
...
let emailName = emailCheck('mon@gmail.com')
...
//CODE HERE
function frogEater(gold) {
  return gold / 3
}
let totalFrogs = frogEater(300)
...
let totalfrogs2 = frogEater2(299)
...
//CODE HERE
function checksArrayAscending(arr) {
...
let arrayIsAscending = checksArrayAscending(sampleArray)
